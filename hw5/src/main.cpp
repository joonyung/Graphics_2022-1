...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "2016-14043 Lee Junyoung", NULL, NULL);
    if (window == NULL)
    {
    ...
    rayTracingShader.setInt("material_ground.material_type", 2);
    ...
    rayTracingShader.setInt("material_mirror.material_type", 5);
    ...
    rayTracingShader.setInt("material_box.material_type", 3);


    rayTracingShader.setVec3("material_lambert.Kd", glm::vec3(0.8, 0.8, 0.0));
    rayTracingShader.setVec3("material_lambert.R0", glm::vec3(0.0f));
    rayTracingShader.setInt("material_lambert.material_type", 6);
    ...
    rayTracingShader.setInt("material_gold.material_type", 4);
